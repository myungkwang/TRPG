...
SCENES: dict[str, dict] = {
    ...
    "tavern_rin": {
        ...
        "event": "EVT_LIN_TALK",
        "text": (
            "GM: 여관의 난롯불 너머, 린은 이미 당신이 올 줄 알았다는 듯 찻잔을 하나 더 내려놓습니다.\n"
            "린 주점 점원: \"어서 오세요. 광산 쪽 손님들이 남긴 말이라면, 주인님께 먼저 여쭤보셔야 해요.\"\n"
            "린: \"광산 이야기는 값이 비싸요. 그래도 손님이 산 쪽으로 갈 거라면, 밤의 그림자부터 보시는 게 좋겠네요.\""
        ),
        "choices": [
