...
const DEFAULT_ANIMATIONS = {
  idle: '/animations/weight_shift.glb',
  talk: '/animations/acknowledging.glb',
  happy: '/animations/happy_hand_gesture.glb',
  angry: '/animations/angry_gesture.glb',
  thinking: '/animations/thoughtful_head_shake.glb',
  deny: '/animations/shaking_head_no.glb',
  sigh: '/animations/relieved_sigh.glb',
  cocky: '/animations/being_cocky.glb',
}
