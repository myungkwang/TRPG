...
"""깊이맵 마이크로서비스 (2.5D 패럴랙스용).
   ...
   모델은 시작 시 1회만 로드한다. kohya venv 로 실행:
     d:/kohya_ss/venv/Scripts/python.exe depth_service.py
   (torch/transformers/PIL/numpy 는 kohya venv 에 이미 있음. 웹서버엔 torch 안 넣어도 됨)
"""
import io, sys
