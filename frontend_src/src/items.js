...
const RAW = [
  ...
  { id:'ITM_UNIQ_REVOLVER', name:'리볼버', icon:'🔫', category:'무기', slot:'무기', unique:'영석 연금술사', tier:1,
    effect:'T1. 어떤 직업이든 착용 가능한 시작 권총', attackBonus:2, modelPath:'/static/models/weapons/old-revolver.glb',
    currency:'-', essence:'-', sources:['직업 시작 장비(영석 연금술사)'],
  ...
  { id:'ITM_UNIQ_ARIA', name:'아리아 리볼버', icon:'🔫', category:'무기', slot:'무기', unique:'영석 연금술사', tier:3,
    effect:'T3. 마르타 우호도가 높은 상태에서 대화로 해금', attackBonus:8, modelPath:'/static/models/weapons/aria-revolver.glb',
    currency:'-', essence:'소량', sources:['마르타 우호도 높을 때 대화 (산기슭 오두막)'],
